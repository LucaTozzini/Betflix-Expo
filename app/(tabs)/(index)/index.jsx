  ...
  return (
    <Div>
      ...
      >
        ...
        <PosterScroll loading={popular.loading} data={popular.data} header={"Popular Movies"} />

        <PosterScroll loading={latest.loading} data={latest.data} header={"Latest on Disc"} />
        <PosterScroll loading={randomShows.loading} data={randomShows.data} header={"TV Shows"} />
